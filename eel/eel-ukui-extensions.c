...
char *
eel_ukui_make_terminal_command (const char *command)
{
...
void
eel_ukui_open_terminal_on_screen (const char *command,
                                  GdkScreen  *screen)
{
    char *command_line;
    ...
    command_line = eel_ukui_make_terminal_command (command);
