...
struct _PeonyProgressInfoClass
{
...
G_DEFINE_TYPE (PeonyProgressInfo, peony_progress_info, G_TYPE_OBJECT)

GList *
peony_get_all_progress_info (void)
{
    GList *l;
...
static void
peony_progress_info_finalize (GObject *object)
{
    PeonyProgressInfo *info;

    info = PEONY_PROGRESS_INFO (object);

    g_free (info->status);
    g_free (info->details);
    g_object_unref (info->cancellable);

    if (G_OBJECT_CLASS (peony_progress_info_parent_class)->finalize)
    {
        (*G_OBJECT_CLASS (peony_progress_info_parent_class)->finalize) (object);
    }
}

static void
peony_progress_info_dispose (GObject *object)
{
    PeonyProgressInfo *info;
...
static void
peony_progress_info_class_init (PeonyProgressInfoClass *klass)
{
    GObjectClass *gobject_class = G_OBJECT_CLASS (klass);

    gobject_class->finalize = peony_progress_info_finalize;
    gobject_class->dispose = peony_progress_info_dispose;

    signals[CHANGED] =
        g_signal_new ("changed",
                      PEONY_TYPE_PROGRESS_INFO,
                      G_SIGNAL_RUN_LAST,
                      0,
                      NULL, NULL,
...
update_data (ProgressWidgetData *data)
{
    ...
    details = peony_progress_info_get_details (data->info);
...
update_progress (ProgressWidgetData *data)
{
    ...
    progress = peony_progress_info_get_progress (data->info);
    if (progress < 0)
    {
...
static void
handle_new_progress_info (PeonyProgressInfo *info)
{
...
static void
peony_progress_info_init (PeonyProgressInfo *info)
{
...
char *
peony_progress_info_get_status (PeonyProgressInfo *info)
{
    char *res;
...
char *
peony_progress_info_get_details (PeonyProgressInfo *info)
{
    char *res;
...
double
peony_progress_info_get_progress (PeonyProgressInfo *info)
{
    double res;
...
void
peony_progress_info_cancel (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
GCancellable *
peony_progress_info_get_cancellable (PeonyProgressInfo *info)
{
    GCancellable *c;
...
gboolean
peony_progress_info_get_is_started (PeonyProgressInfo *info)
{
    gboolean res;
...
gboolean
peony_progress_info_get_is_finished (PeonyProgressInfo *info)
{
    gboolean res;
...
gboolean
peony_progress_info_get_is_paused (PeonyProgressInfo *info)
{
    gboolean res;
...
static void
queue_idle (PeonyProgressInfo *info, gboolean now)
{
...
void
peony_progress_info_pause (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_resume (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_start (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_finish (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_take_status (PeonyProgressInfo *info,
                                char *status)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_set_status (PeonyProgressInfo *info,
                               const char *status)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_take_details (PeonyProgressInfo *info,
                                 char           *details)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_set_details (PeonyProgressInfo *info,
                                const char           *details)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_pulse_progress (PeonyProgressInfo *info)
{
    G_LOCK (progress_info);
...
void
peony_progress_info_set_progress (PeonyProgressInfo *info,
                                 double                current,
                                 double                total)
{
