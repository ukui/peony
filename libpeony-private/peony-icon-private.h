...
#ifndef PEONY_ICON_CONTAINER_PRIVATE_H
#define PEONY_ICON_CONTAINER_PRIVATE_H

#include <eel/eel-glib-extensions.h>
#include <libpeony-private/peony-icon-canvas-item.h>
...
/* Private PeonyIconContainer members. */
...
struct PeonyIconContainerDetails
{
    ...
    PeonyIcon *keyboard_icon_to_reveal;
    ...
    PeonyIcon *double_click_icon[2]; /* Both clicks in a double click need to be on the same icon */
    ...
    /* Layout mode */
    PeonyIconLayoutMode layout_mode;

    /* Label position */
    PeonyIconLabelPosition label_position;
...
PeonyIcon *peony_icon_container_get_icon_by_uri             (PeonyIconContainer *container,
        const char            *uri);
void          peony_icon_container_move_icon                   (PeonyIconContainer *container,
        PeonyIcon          *icon,
        int                    x,
        int                    y,
        double                 scale,
...
void          peony_icon_container_select_list_unselect_others (PeonyIconContainer *container,
        GList                 *icons);
char *        peony_icon_container_get_icon_uri                (PeonyIconContainer *container,
        PeonyIcon          *icon);
char *        peony_icon_container_get_icon_drop_target_uri    (PeonyIconContainer *container,
        PeonyIcon          *icon);
void          peony_icon_container_update_icon                 (PeonyIconContainer *container,
        PeonyIcon          *icon);
gboolean      peony_icon_container_has_stored_icon_positions   (PeonyIconContainer *container);
gboolean      peony_icon_container_emit_preview_signal         (PeonyIconContainer *view,
        PeonyIcon          *icon,
        gboolean               start_flag);
gboolean      peony_icon_container_scroll                      (PeonyIconContainer *container,
        int                    delta_x,
        int                    delta_y);
