/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   peony-monitor.c: file and directory change monitoring for peony
             ...
             gpointer user_data)
{
    ...
    case G_FILE_MONITOR_EVENT_CHANGES_DONE_HINT:
        peony_file_changes_queue_file_changed (child);
        break;
    case G_FILE_MONITOR_EVENT_DELETED:
        peony_file_changes_queue_file_removed (child);
        break;
    case G_FILE_MONITOR_EVENT_CREATED:
        peony_file_changes_queue_file_added (child);
        break;
...
PeonyMonitor *
peony_monitor_directory (GFile *location)
{
    GFileMonitor *dir_monitor;
    PeonyMonitor *ret;
...
void
peony_monitor_cancel (PeonyMonitor *monitor)
{
