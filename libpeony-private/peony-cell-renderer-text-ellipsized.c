...
#include "peony-cell-renderer-text-ellipsized.h"
...
static void
peony_cell_renderer_text_ellipsized_get_preferred_width (GtkCellRenderer *cell,
        						    GtkWidget       *widget,
        						    gint            *minimum_size,
        						    gint            *natural_size)
{
    ...
    GTK_CELL_RENDERER_CLASS
            (peony_cell_renderer_text_ellipsized_parent_class)->get_preferred_width (cell, widget,
...
GtkCellRenderer *
peony_cell_renderer_text_ellipsized_new (void)
{
    return g_object_new (PEONY_TYPE_CELL_RENDERER_TEXT_ELLIPSIZED, NULL);
}
