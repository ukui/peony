...
static void
view_as_menu_switch_views_callback (GtkComboBox *combo_box, PeonyNavigationWindow *window)
{
    int active;
    ...
    {
        activate_nth_short_list_item (PEONY_WINDOW (window), active);
    }
    else
    {
        activate_extra_viewer (PEONY_WINDOW (window));
    }
}
