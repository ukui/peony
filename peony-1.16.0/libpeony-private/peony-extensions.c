...
#define PEONY_EXTENSION_GROUP "Peony Extension"

static GList *peony_extensions = NULL;
...
gsettings_key_has_value (const gchar *value)
{
    ...
    list = g_settings_get_strv (peony_extension_preferences, 
                                PEONY_PREFERENCES_DISABLED_EXTENSIONS);
...
gsettings_append_to_list (const char *value)
{
    ...
    current = g_settings_get_strv (peony_extension_preferences, 
                                   PEONY_PREFERENCES_DISABLED_EXTENSIONS);
    ...
    retval = g_settings_set_strv (peony_extension_preferences, 
                                  PEONY_PREFERENCES_DISABLED_EXTENSIONS,
                                 (const gchar **) new);
...
static gboolean
peony_extension_get_state (const gchar *extname)
{
...
GList *
peony_extensions_get_list (void)
{
    return peony_extensions;
}
...
gboolean
peony_extension_set_state (Extension *ext, gboolean new_state)
{
    if (ext)
    {
