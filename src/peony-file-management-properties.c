...
#define PEONY_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET "default_view_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET "icon_view_zoom_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET "compact_view_zoom_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET "list_view_zoom_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET "sort_order_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET "date_format_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET "preview_text_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET "preview_image_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_SOUND_WIDGET "preview_sound_combobox"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET "preview_folder_combobox"

/* bool preferences */
#define PEONY_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET "sort_folders_first_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_COMPACT_LAYOUT_WIDGET "compact_layout_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET "labels_beside_icons_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH "all_columns_same_width_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET "always_use_browser_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_LOCATION_ENTRY_WIDGET "always_use_location_entry_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET "trash_confirm_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_TRASH_WIDGET "trash_confirm_trash_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET "trash_delete_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET "hidden_files_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET "treeview_folders_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTOMOUNT_OPEN "media_automount_open_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTORUN_NEVER "media_autorun_never_checkbutton"
#define PEONY_FILE_MANAGEMENT_PROPERTIES_USE_IEC_UNITS_WIDGET "use_iec_units"

/* int enums */
#define PEONY_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET "preview_image_size_combobox"
...
static void peony_file_management_properties_dialog_update_media_sensitivity (GtkBuilder *builder);

static void
peony_file_management_properties_size_group_create (GtkBuilder *builder,
        char *prefix,
        int items)
{
...
static void
peony_file_management_properties_dialog_response_cb (GtkDialog *parent,
        int response_id,
        GtkBuilder *builder)
{
    char *section;
    ...
    if (response_id == GTK_RESPONSE_HELP)
    {
        ...
        default:
        case 0:
            section = "gospeony-438";
            break;
        case 1:
            section = "gospeony-56";
            break;
        case 2:
            section = "gospeony-439";
            break;
        case 3:
            section = "gospeony-490";
            break;
        case 4:
            section = "gospeony-60";
            break;
    ...
    {
        g_signal_handlers_disconnect_by_func (peony_media_preferences,
                                              peony_file_management_properties_dialog_update_media_sensitivity,
                                              builder);
    }
}

static void
columns_changed_callback (PeonyColumnChooser *chooser,
                          gpointer callback_data)
{
    char **visible_columns;
    char **column_order;

    peony_column_chooser_get_settings (PEONY_COLUMN_CHOOSER (chooser),
                                      &visible_columns,
                                      &column_order);

    g_settings_set_strv (peony_list_view_preferences,
                                ...
                                gpointer user_data)
{
    ...
    g_settings_set_strv (peony_icon_view_preferences,
...
update_icon_captions_from_settings (GtkBuilder *builder)
{
    ...
    captions = g_settings_get_strv (peony_icon_view_preferences, PEONY_PREFERENCES_ICON_VIEW_CAPTIONS);
    if (captions == NULL)
        return;
...
static void
peony_file_management_properties_dialog_setup_icon_caption_page (GtkBuilder *builder)
{
    GList *columns;
    int i;
    gboolean writable;

    writable = g_settings_is_writable (peony_icon_view_preferences, PEONY_PREFERENCES_ICON_VIEW_CAPTIONS);
    ...
    peony_column_list_free (columns);
...
create_date_format_menu (GtkBuilder *builder)
{
    ...
    combo_box = GTK_COMBO_BOX_TEXT
            (gtk_builder_get_object (builder,
                                     PEONY_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET));
...
static void
set_columns_from_settings (PeonyColumnChooser *chooser)
{
    char **visible_columns;
    char **column_order;

    visible_columns = g_settings_get_strv (peony_list_view_preferences,
                                           PEONY_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
    column_order = g_settings_get_strv (peony_list_view_preferences,
                                        PEONY_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);

    peony_column_chooser_set_settings (PEONY_COLUMN_CHOOSER (chooser),
                                      visible_columns,
                                      column_order);
...
static void
use_default_callback (PeonyColumnChooser *chooser,
                      gpointer user_data)
{
    g_settings_reset (peony_list_view_preferences,
                      PEONY_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
    g_settings_reset (peony_list_view_preferences,
                      PEONY_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);
...
static void
peony_file_management_properties_dialog_setup_list_column_page (GtkBuilder *builder)
{
    GtkWidget *chooser;
    GtkWidget *box;

    chooser = peony_column_chooser_new (NULL);
    ...
    set_columns_from_settings (PEONY_COLUMN_CHOOSER (chooser));
...
static void
peony_file_management_properties_dialog_update_media_sensitivity (GtkBuilder *builder)
{
    gtk_widget_set_sensitive (GTK_WIDGET (gtk_builder_get_object (builder, "media_handling_vbox")),
                              ! g_settings_get_boolean (peony_media_preferences, PEONY_PREFERENCES_MEDIA_AUTORUN_NEVER));
}
...
other_type_combo_box_changed (GtkComboBox *combo_box, GtkComboBox *action_combo_box)
{
    ...
    peony_autorun_prepare_combo_box (GTK_WIDGET (action_combo_box),
                                    x_content_type,
                                    TRUE,
                                    TRUE,
                                    TRUE,
...
extension_state_toggled (GtkCellRendererToggle *cell, gchar *path_str, gpointer data)
{
	...
	if (&iter != NULL)
    {
        ...
        if (peony_extension_set_state (ext, new_state))
        {
...
static void
peony_file_management_properties_dialog_setup_media_page (GtkBuilder *builder)
{
    unsigned int n;
    GList *l;
    GList *content_types;
    ...
    {
        peony_autorun_prepare_combo_box (GTK_WIDGET (gtk_builder_get_object (builder, s[n*2])), s[n*2 + 1],
    ...
    for (l = content_types; l != NULL; l = l->next)
    {
        ...
        if (icon != NULL)
        {
            ...
            g_object_unref (icon);
            pixbuf = peony_icon_info_get_pixbuf_nodefault_at_size (icon_info, icon_size);
...
skip:
    ...
    peony_file_management_properties_dialog_update_media_sensitivity (builder);
}

static void
peony_file_management_properties_dialog_setup_extension_page (GtkBuilder *builder)
{
    ...
    extensions = peony_extensions_get_list ();
...
static  void
peony_file_management_properties_dialog_setup (GtkBuilder *builder, GtkWindow *window)
{
    GtkWidget *dialog;

    /* setup UI */
    peony_file_management_properties_size_group_create (builder,
            "views_label",
            5);
    peony_file_management_properties_size_group_create (builder,
            "captions_label",
    ...
    /* setup preferences */
    bind_builder_bool (builder, peony_icon_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_COMPACT_LAYOUT_WIDGET,
                       PEONY_PREFERENCES_ICON_VIEW_DEFAULT_USE_TIGHTER_LAYOUT);
    bind_builder_bool (builder, peony_icon_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET,
                       PEONY_PREFERENCES_ICON_VIEW_LABELS_BESIDE_ICONS);
    bind_builder_bool (builder, peony_compact_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH,
                       PEONY_PREFERENCES_COMPACT_VIEW_ALL_COLUMNS_SAME_WIDTH);
    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET,
                       PEONY_PREFERENCES_SORT_DIRECTORIES_FIRST);
    bind_builder_bool_inverted (builder, peony_preferences,
                                PEONY_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET,
                                PEONY_PREFERENCES_ALWAYS_USE_BROWSER);

    bind_builder_bool (builder, peony_media_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTOMOUNT_OPEN,
                       PEONY_PREFERENCES_MEDIA_AUTOMOUNT_OPEN);
    bind_builder_bool (builder, peony_media_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_MEDIA_AUTORUN_NEVER,
                       PEONY_PREFERENCES_MEDIA_AUTORUN_NEVER);

    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET,
                       PEONY_PREFERENCES_CONFIRM_TRASH);
    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_TRASH_WIDGET,
                       PEONY_PREFERENCES_CONFIRM_MOVE_TO_TRASH);

    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET,
                       PEONY_PREFERENCES_ENABLE_DELETE);
    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET,
                       PEONY_PREFERENCES_SHOW_HIDDEN_FILES);
    bind_builder_bool (builder, peony_tree_sidebar_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET,
                       PEONY_PREFERENCES_TREE_SHOW_ONLY_DIRECTORIES);

    bind_builder_bool (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_USE_IEC_UNITS_WIDGET,
                       PEONY_PREFERENCES_USE_IEC_UNITS);

    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET,
                       PEONY_PREFERENCES_DEFAULT_FOLDER_VIEWER,
                       (const char **) default_view_values);
    bind_builder_enum (builder, peony_icon_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET,
                       PEONY_PREFERENCES_ICON_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, peony_compact_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET,
                       PEONY_PREFERENCES_COMPACT_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, peony_list_view_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET,
                       PEONY_PREFERENCES_LIST_VIEW_DEFAULT_ZOOM_LEVEL,
                       (const char **) zoom_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET,
                       PEONY_PREFERENCES_DEFAULT_SORT_ORDER,
                       (const char **) sort_order_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET,
                       PEONY_PREFERENCES_SHOW_TEXT_IN_ICONS,
                       (const char **) preview_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET,
                       PEONY_PREFERENCES_SHOW_IMAGE_FILE_THUMBNAILS,
                       (const char **) preview_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_SOUND_WIDGET,
                       PEONY_PREFERENCES_PREVIEW_SOUND,
                       (const char **) preview_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET,
                       PEONY_PREFERENCES_SHOW_DIRECTORY_ITEM_COUNTS,
                       (const char **) preview_values);
    bind_builder_enum (builder, peony_preferences,
                       PEONY_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET,
    ...
    bind_builder_radio (builder, peony_preferences,
    ...
    bind_builder_radio (builder, peony_preferences,
                        ...
                        PEONY_PREFERENCES_EXECUTABLE_TEXT_ACTIVATION,
                        (const char **) executable_text_values);

    bind_builder_uint_enum (builder, peony_preferences,
                            PEONY_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET,
                            PEONY_PREFERENCES_IMAGE_FILE_THUMBNAIL_LIMIT,
                            thumbnail_limit_values,
                            G_N_ELEMENTS (thumbnail_limit_values));

    peony_file_management_properties_dialog_setup_icon_caption_page (builder);
    peony_file_management_properties_dialog_setup_list_column_page (builder);
    peony_file_management_properties_dialog_setup_media_page (builder);
    peony_file_management_properties_dialog_setup_extension_page (builder);

    g_signal_connect_swapped (peony_media_preferences,
                              "changed::" PEONY_PREFERENCES_MEDIA_AUTORUN_NEVER,
                              G_CALLBACK(peony_file_management_properties_dialog_update_media_sensitivity),
                              builder);
    ...
    g_signal_connect_data (G_OBJECT (dialog), "response",
                           G_CALLBACK (peony_file_management_properties_dialog_response_cb),
...
void
peony_file_management_properties_dialog_show (GCallback close_callback, GtkWindow *window)
{
    GtkBuilder *builder;
    ...
    gtk_builder_add_from_file (builder,
                               UIDIR "/peony-file-management-properties.ui",
                               NULL);
    ...
    peony_file_management_properties_dialog_setup (builder, window);
