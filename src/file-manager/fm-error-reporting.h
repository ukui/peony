...
void fm_report_error_loading_directory	 (PeonyFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_renaming_file       (PeonyFile   *file,
        const char     *new_name,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_permissions (PeonyFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_owner       (PeonyFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);
void fm_report_error_setting_group       (PeonyFile   *file,
        GError         *error,
        GtkWindow	 *parent_window);

/* FIXME bugzilla.gnome.org 42394: Should this file be renamed or should this function be moved? */
void fm_rename_file                      (PeonyFile   *file,
        const char     *new_name,
