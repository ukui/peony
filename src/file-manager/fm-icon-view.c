...
static void fm_icon_view_iface_init (PeonyViewIface *iface);
...
set_tighter_layout (FMIconView *icon_view, gboolean new_value)
{
    fm_icon_view_set_directory_tighter_layout (icon_view,
            ...
            new_value);
    peony_icon_container_set_tighter_layout (get_icon_container (icon_view),
                                            new_value);
}
...
{
    return peony_icon_container_is_tighter_layout
           (get_icon_container (icon_view));
}
...
static void
fm_icon_view_remove_file (FMDirectoryView *view, PeonyFile *file, PeonyDirectory *directory)
{
    FMIconView *icon_view;
    ...
    if (peony_icon_container_remove (get_icon_container (icon_view),
...
static void
fm_icon_view_add_file (FMDirectoryView *view, PeonyFile *file, PeonyDirectory *directory)
{
    FMIconView *icon_view;
    PeonyIconContainer *icon_container;
...
{
    peony_icon_container_layout_now (get_icon_container (FM_ICON_VIEW (view)));
}

static void
fm_icon_view_file_changed (FMDirectoryView *view, PeonyFile *file, PeonyDirectory *directory)
{
    FMIconView *icon_view;
...
update_layout_menus (FMIconView *view)
{
    ...
    gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action),
                                  peony_icon_container_is_keep_aligned (get_icon_container (view)));
    gtk_action_set_sensitive (action, !is_auto_layout);
}
        ...
        gboolean tighter_layout)
{
    ...
    peony_file_set_boolean_metadata
    (file, PEONY_METADATA_KEY_ICON_VIEW_TIGHTER_LAYOUT,
     get_default_directory_tighter_layout (),
     tighter_layout);
}
...
get_default_zoom_level (FMIconView *icon_view)
{
    ...
    return CLAMP (DEFAULT_ZOOM_LEVEL(icon_view), PEONY_ZOOM_LEVEL_SMALLEST, PEONY_ZOOM_LEVEL_LARGEST);
}
...
set_labels_beside_icons (FMIconView *icon_view)
{
    ...
    if (fm_icon_view_supports_labels_beside_icons (icon_view))
    {
        labels_beside = fm_icon_view_is_compact (icon_view) ||
                        g_settings_get_boolean (peony_icon_view_preferences, PEONY_PREFERENCES_ICON_VIEW_LABELS_BESIDE_ICONS);
...
set_columns_same_width (FMIconView *icon_view)
{
    ...
    if (fm_icon_view_is_compact (icon_view))
    {
        ...
        peony_icon_container_set_all_columns_same_width (get_icon_container (icon_view), all_columns_same_width);
    }
}
...
fm_icon_view_begin_loading (FMDirectoryView *view)
{
    ...
    peony_icon_container_begin_loading (PEONY_ICON_CONTAINER (icon_container));

    peony_icon_container_set_allow_moves (PEONY_ICON_CONTAINER (icon_container),
    ...
    peony_icon_container_set_tighter_layout
    (get_icon_container (icon_view),
...
static void
icon_view_notify_clipboard_info (PeonyClipboardMonitor *monitor,
                          ...
                          gboolean all_files_seen)
{
    ...
    icon_container = GTK_WIDGET (get_icon_container (icon_view));
    peony_icon_container_end_loading (PEONY_ICON_CONTAINER (icon_container), all_files_seen);
...
fm_icon_view_get_selection (FMDirectoryView *view)
{
    ...
    list = peony_icon_container_get_selection
           (get_icon_container (FM_ICON_VIEW (view)));
                                 ...
                                 PeonyFileSortType  sort_type)
{
    ...
    peony_icon_container_sort (get_icon_container (icon_view));
                              ...
                              gpointer user_data)
{
    ...
    peony_icon_container_set_keep_aligned (get_icon_container (icon_view),
                                          keep_aligned);
}
...
{
    if (!(fm_icon_view_get_zoom_level (view) > PEONY_ZOOM_LEVEL_SMALLEST))
    {
        return FALSE;
    }
...
fm_icon_view_get_selected_icon_locations (FMDirectoryView *view)
{
    ...
    return peony_icon_container_get_selected_icon_locations
           (get_icon_container (FM_ICON_VIEW (view)));
}
        ...
        FMIconView *icon_view)
{
    ...
    window_info = fm_directory_view_get_peony_window (FM_DIRECTORY_VIEW (icon_view));
...
static void
preview_audio (FMIconView *icon_view, PeonyFile *file, gboolean start_flag)
{
                                 ...
                                 FMIconView *icon_view)
{
     ...
     */
    if (fm_icon_view_get_zoom_level (FM_DIRECTORY_VIEW (icon_view)) <= PEONY_ZOOM_LEVEL_SMALLER)
    {
        if (start_flag)
        {
            ...
            (fm_directory_view_get_peony_window_slot (FM_DIRECTORY_VIEW (icon_view)),
             message);
            g_free (message);
        }
        else
...
static void
fm_icon_view_icon_text_changed_callback (PeonyIconContainer *container,
        PeonyFile *file,
        char *new_name,
        FMIconView *icon_view)
{
...
fm_icon_view_text_attribute_names_changed (FMDirectoryView *directory_view)
{
    ...
    peony_icon_container_request_update_all (get_icon_container (FM_ICON_VIEW (directory_view)));
}
...
static gboolean
icon_view_can_accept_item (PeonyIconContainer *container,
...
static char *
icon_view_get_container_uri (PeonyIconContainer *container,
                             FMDirectoryView *view)
{
...
static void
icon_view_move_copy_items (PeonyIconContainer *container,
...
focus_in_event_callback (GtkWidget *widget, GdkEventFocus *event, gpointer user_data)
{
    ...
    slot_info = fm_directory_view_get_peony_window_slot (FM_DIRECTORY_VIEW (icon_view));
...
static void
icon_view_handle_netscape_url (PeonyIconContainer *container, const char *encoded_url,
...
static void
icon_view_handle_uri_list (PeonyIconContainer *container, const char *item_uris,
                           const char *target_uri,
                           GdkDragAction action, int x, int y, FMIconView *view)
{
...
static void
icon_view_handle_text (PeonyIconContainer *container, const char *text,
                       const char *target_uri,
                       GdkDragAction action, int x, int y, FMIconView *view)
{
...
static void
icon_view_handle_raw (PeonyIconContainer *container, const char *raw_data,
...
static char *
icon_view_get_first_visible_file (PeonyView *view)
{
    PeonyFile *file;
    FMIconView *icon_view;
    ...
    file = PEONY_FILE (peony_icon_container_get_first_visible_icon (get_icon_container (icon_view)));
...
static void
icon_view_scroll_to_file (PeonyView *view,
                          const char *uri)
{
    PeonyFile *file;
    FMIconView *icon_view;
    ...
    if (uri != NULL)
    {
        ...
        if (file != NULL)
        {
            peony_icon_container_scroll_to_icon (get_icon_container (icon_view),
                                                PEONY_ICON_CONTAINER_ICON_DATA (file));
            peony_file_unref (file);
        }
    }
                           ...
                           GParamSpec      *pspec)
{
    ...
    case PROP_COMPACT:
        ...
        if (icon_view->details->compact)
        {
            peony_icon_container_set_layout_mode (get_icon_container (icon_view),
                                                 gtk_widget_get_direction (GTK_WIDGET(icon_view)) == GTK_TEXT_DIR_RTL ?
                                                 PEONY_ICON_LAYOUT_T_B_R_L :
                                                 PEONY_ICON_LAYOUT_T_B_L_R);
            peony_icon_container_set_forced_icon_size (get_icon_container (icon_view),
                    PEONY_ICON_SIZE_SMALLEST);
        }
        break;
...
static const char *
fm_icon_view_get_id (PeonyView *view)
{
    if (FM_IS_DESKTOP_ICON_VIEW (view))
    {
...
static void
fm_icon_view_iface_init (PeonyViewIface *iface)
{
...
fm_icon_view_init (FMIconView *icon_view)
{
    ...
    g_signal_connect_swapped (peony_icon_view_preferences,
                              "changed::" PEONY_PREFERENCES_ICON_VIEW_DEFAULT_USE_TIGHTER_LAYOUT,
    ...
    g_signal_connect_swapped (peony_icon_view_preferences,
                              ...
                              icon_view);
    g_signal_connect_swapped (peony_icon_view_preferences,
                              "changed::" PEONY_PREFERENCES_ICON_VIEW_LABELS_BESIDE_ICONS,
                              G_CALLBACK (labels_beside_icons_changed_callback),
                              icon_view);

    g_signal_connect_swapped (peony_compact_view_preferences,
                              "changed::" PEONY_PREFERENCES_COMPACT_VIEW_DEFAULT_ZOOM_LEVEL,
                              G_CALLBACK (default_zoom_level_changed_callback),
                              icon_view);
    g_signal_connect_swapped (peony_compact_view_preferences,
                              "changed::" PEONY_PREFERENCES_COMPACT_VIEW_ALL_COLUMNS_SAME_WIDTH,
...
static PeonyView *
fm_icon_view_create (PeonyWindowSlotInfo *slot)
{
    FMIconView *view;
...
static PeonyView *
fm_compact_view_create (PeonyWindowSlotInfo *slot)
{
    FMIconView *view;
...
static PeonyViewInfo fm_icon_view =
{
    FM_ICON_VIEW_ID,
...
static PeonyViewInfo fm_compact_view =
{
    FM_COMPACT_VIEW_ID,
    /* translators: this is used in the view selection dropdown
     * of navigation windows and in the preferences dialog */
...
fm_icon_view_register (void)
{
    ...
    peony_view_factory_register (&fm_icon_view);
}
...
fm_compact_view_register (void)
{
    ...
    peony_view_factory_register (&fm_compact_view);
}
