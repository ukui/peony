...
/* peony-self-check-functions.h: Wrapper and prototypes for all self
 * check functions in Peony proper.
 */
...
#define PEONY_FOR_EACH_SELF_CHECK_FUNCTION(macro) \
/* Add new self-check functions to the list above this line. */

/* Generate prototypes for all the functions. */
PEONY_FOR_EACH_SELF_CHECK_FUNCTION (PEONY_SELF_CHECK_FUNCTION_PROTOTYPE)
